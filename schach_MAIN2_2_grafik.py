...
#Zeile 1
button1 = Button(fenster, text=feld[0][0],bg='white',fg='black',command = lambda: button_Funktion(0,0))
button2 = Button(fenster, text=feld[0][1],bg='black',fg='white',command = lambda: button_Funktion(0,1))
button3 = Button(fenster, text=feld[0][2],bg='white',fg='black',command = lambda: button_Funktion(0,2))
button4 = Button(fenster, text=feld[0][3],bg='black',fg='white',command = lambda: button_Funktion(0,3))
button5 = Button(fenster, text=feld[0][4],bg='white',fg='black',command = lambda: button_Funktion(0,4))
button6 = Button(fenster, text=feld[0][5],bg='black',fg='white',command = lambda: button_Funktion(0,5))
button7 = Button(fenster, text=feld[0][6],bg='white',fg='black',command = lambda: button_Funktion(0,6))
button8 = Button(fenster, text=feld[0][7],bg='black',fg='white',command = lambda: button_Funktion(0,7))
#Zeile 2
button9 = Button(fenster, text=feld[1][0],bg='black',fg='white',command = lambda: button_Funktion(1,0))
button10 = Button(fenster, text=feld[1][1],bg='white',fg='black',command = lambda: button_Funktion(1,1))
button11 = Button(fenster, text=feld[1][2],bg='black',fg='white',command = lambda: button_Funktion(1,2))
button12 = Button(fenster, text=feld[1][3],bg='white',fg='black',command = lambda: button_Funktion(1,3))
button13 = Button(fenster, text=feld[1][4],bg='black',fg='white',command = lambda: button_Funktion(1,4))
button14 = Button(fenster, text=feld[1][5],bg='white',fg='black',command = lambda: button_Funktion(1,5))
button15 = Button(fenster, text=feld[1][6],bg='black',fg='white',command = lambda: button_Funktion(1,6))
button16 = Button(fenster, text=feld[1][7],bg='white',fg='black',command = lambda: button_Funktion(1,7))
#Zeile 3
button17 = Button(fenster, text=feld[2][0],bg='white',fg='black',command = lambda: button_Funktion(2,0))
button18 = Button(fenster, text=feld[2][1],bg='black',fg='white',command = lambda: button_Funktion(2,1))
button19 = Button(fenster, text=feld[2][2],bg='white',fg='black',command = lambda: button_Funktion(2,2))
button20 = Button(fenster, text=feld[2][3],bg='black',fg='white',command = lambda: button_Funktion(2,3))
button21 = Button(fenster, text=feld[2][4],bg='white',fg='black',command = lambda: button_Funktion(2,4))
button22 = Button(fenster, text=feld[2][5],bg='black',fg='white',command = lambda: button_Funktion(2,5))
button23 = Button(fenster, text=feld[2][6],bg='white',fg='black',command = lambda: button_Funktion(2,6))
button24 = Button(fenster, text=feld[2][7],bg='black',fg='white',command = lambda: button_Funktion(2,7))
#Zeile 4
button25 = Button(fenster, text=feld[3][0],bg='black',fg='white',command = lambda: button_Funktion(3,0))
button26 = Button(fenster, text=feld[3][1],bg='white',fg='black',command = lambda: button_Funktion(3,1))
button27 = Button(fenster, text=feld[3][2],bg='black',fg='white',command = lambda: button_Funktion(3,2))
button28 = Button(fenster, text=feld[3][3],bg='white',fg='black',command = lambda: button_Funktion(3,3))
button29 = Button(fenster, text=feld[3][4],bg='black',fg='white',command = lambda: button_Funktion(3,4))
button30 = Button(fenster, text=feld[3][5],bg='white',fg='black',command = lambda: button_Funktion(3,5))
button31 = Button(fenster, text=feld[3][6],bg='black',fg='white',command = lambda: button_Funktion(3,6))
button32 = Button(fenster, text=feld[3][7],bg='white',fg='black',command = lambda: button_Funktion(3,7))
#Zeile 5
button33 = Button(fenster, text=feld[4][0],bg='white',fg='black',command = lambda: button_Funktion(4,0))
button34 = Button(fenster, text=feld[4][1],bg='black',fg='white',command = lambda: button_Funktion(4,1))
button35 = Button(fenster, text=feld[4][2],bg='white',fg='black',command = lambda: button_Funktion(4,2))
button36 = Button(fenster, text=feld[4][3],bg='black',fg='white',command = lambda: button_Funktion(4,3))
button37 = Button(fenster, text=feld[4][4],bg='white',fg='black',command = lambda: button_Funktion(4,4))
button38 = Button(fenster, text=feld[4][5],bg='black',fg='white',command = lambda: button_Funktion(4,5))
button39 = Button(fenster, text=feld[4][6],bg='white',fg='black',command = lambda: button_Funktion(4,6))
button40 = Button(fenster, text=feld[4][7],bg='black',fg='white',command = lambda: button_Funktion(4,7))
#Zeile 6
button41 = Button(fenster, text=feld[5][0],bg='black',fg='white',command = lambda: button_Funktion(5,0))
button42 = Button(fenster, text=feld[5][1],bg='white',fg='black',command = lambda: button_Funktion(5,1))
button43 = Button(fenster, text=feld[5][2],bg='black',fg='white',command = lambda: button_Funktion(5,2))
button44 = Button(fenster, text=feld[5][3],bg='white',fg='black',command = lambda: button_Funktion(5,3))
button45 = Button(fenster, text=feld[5][4],bg='black',fg='white',command = lambda: button_Funktion(5,4))
button46 = Button(fenster, text=feld[5][5],bg='white',fg='black',command = lambda: button_Funktion(5,5))
button47 = Button(fenster, text=feld[5][6],bg='black',fg='white',command = lambda: button_Funktion(5,6))
button48 = Button(fenster, text=feld[5][7],bg='white',fg='black',command = lambda: button_Funktion(5,7))
#Zeile 7
button49 = Button(fenster, text=feld[6][0],bg='white',fg='black',command = lambda: button_Funktion(6,0))
button50 = Button(fenster, text=feld[6][1],bg='black',fg='white',command = lambda: button_Funktion(6,1))
button51 = Button(fenster, text=feld[6][2],bg='white',fg='black',command = lambda: button_Funktion(6,2))
button52 = Button(fenster, text=feld[6][3],bg='black',fg='white',command = lambda: button_Funktion(6,3))
button53 = Button(fenster, text=feld[6][4],bg='white',fg='black',command = lambda: button_Funktion(6,4))
button54 = Button(fenster, text=feld[6][5],bg='black',fg='white',command = lambda: button_Funktion(6,5))
button55 = Button(fenster, text=feld[6][6],bg='white',fg='black',command = lambda: button_Funktion(6,6))
button56 = Button(fenster, text=feld[6][7],bg='black',fg='white',command = lambda: button_Funktion(6,7))
#Zeile 8
button57 = Button(fenster, text=feld[7][0],bg='black',fg='white',command = lambda: button_Funktion(7,0))
button58 = Button(fenster, text=feld[7][1],bg='white',fg='black',command = lambda: button_Funktion(7,1))
button59 = Button(fenster, text=feld[7][2],bg='black',fg='white',command = lambda: button_Funktion(7,2))
button60 = Button(fenster, text=feld[7][3],bg='white',fg='black',command = lambda: button_Funktion(7,3))
button61 = Button(fenster, text=feld[7][4],bg='black',fg='white',command = lambda: button_Funktion(7,4))
button62 = Button(fenster, text=feld[7][5],bg='white',fg='black',command = lambda: button_Funktion(7,5))
button63 = Button(fenster, text=feld[7][6],bg='black',fg='white',command = lambda: button_Funktion(7,6))
button64 = Button(fenster, text=feld[7][7],bg='white',fg='black',command = lambda: button_Funktion(7,7))
